namespace WebApiDemo.Models.Repositories
{
    public static class ShirtRepository
    {
        private static List<Shirt> shirts = new List<Shirt>()
        {
            ...
            new Shirt {ShirtId = 2, Brand = "My Brand", Color = "Blue", Gender = "Men", Price = 30, Size = 10},
            new Shirt {ShirtId = 3, Brand = "My Brand", Color = "Blue", Gender = "Women", Price = 30, Size = 10},
            new Shirt {ShirtId = 4, Brand = "My Brand", Color = "Blue", Gender = "Women", Price = 30, Size = 10},
        };
